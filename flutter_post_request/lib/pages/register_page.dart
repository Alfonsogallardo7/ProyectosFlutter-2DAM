    ...
    return Scaffold(
      body: Center(
        child: Container(
          ...
          child: (_futureRegister == null) ? buildForm(context) : buildFutureBuilder(),
        ),
      ),
    );
  }
...
Future<RegisterResponse> _doRegister(BuildContext context) async {
    RegisterDto _loginDto = RegisterDto(
        email: emailController.text,username: usernameController.text, password: passwordController.text);
